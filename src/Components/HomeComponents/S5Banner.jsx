...
import tokenImg2 from "../../assets/banner/1.png"; // CoinMarketCap banner

const FullWidthBanner = () => {
  return (
    <section className="w-full bg-black flex justify-center items-center py-6 px-4 sm:px-6 lg:px-12 overflow-x-hidden">
      <img
        src={tokenImg2}
        alt="CoinMarketCap Banner"
        className="w-full  object-contain cursor-pointer    rounded-lg border border-[#FFF] shadow-[0_0_20px_rgba(255,140,0,0.5)]  z-10 "
        onClick={() =>
          window.open(
            "https://coinmarketcap.com/currencies/crypgpt-token/",
            "_blank"
          )
        }
      />
