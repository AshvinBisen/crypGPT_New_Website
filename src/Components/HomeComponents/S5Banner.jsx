...
const slides = [
  { id: 1, image: tokenImg1, link: "https://coinmarketcap.com/currencies/crypgpt-token/" },
  { id: 2, image: tokenImg2, link: "https://pancakeswap.finance/swap?inputCurrency=0x55d398326f99059fF775485246999027B3197955&outputCurrency=0xC643F4Dd66a10955e53E3f67A81Ba54703d3B7FB" },
  { id: 3, image: tokenImg3, link: "https://coinmarketcap.com/currencies/crypgpt-token/" },
  { id: 4, image: tokenImg4, link: "https://pancakeswap.finance/swap?inputCurrency=0x55d398326f99059fF775485246999027B3197955&outputCurrency=0xC643F4Dd66a10955e53E3f67A81Ba54703d3B7FB" },
];
...
const BannerSlider = () => {
  ...
  return (
    <section id="banner" className="relative w-full bg-black sm:py-3 md:py-6 py-16 flex flex-col items-center overflow-hidden">
      ...
      {/* Slider Container */}
      <div className="relative w-[90%] md:w-[70%] flex items-center justify-center  py-5 px-6 m-8 ">
     ...
     <div className="absolute top-0 left-[5px] md:left-[5px] ">
        ...
        <div className="relative w-full h-full flex justify-center items-center py-6 px-4 gap-4 lg:gap-8 overflow-hidden">
